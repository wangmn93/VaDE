...
class Parametric_tSNE(object):
    ...
    def pretrain(self,training_data, epochs=10, verbose=0):
        self._pretrain_layers(training_data, batch_size=256, epochs=epochs, verbose=verbose)

    def finetune(self,training_data, training_betas=None, epochs=10, verbose=0):
